...
def test_policy_adds_exploratory_bucket_and_preserves_fail_closed_authority():
    ...
    original_factory = bucket_policy.default_multi_strategy_candidates
    original_supported = bucket_policy.SUPPORTED_BUCKETS
    original_ids = dict(bucket_policy.BUCKET_STRATEGY_IDS)
    try:
        ...
        bucket_policy.default_multi_strategy_candidates = original_factory
        bucket_policy.SUPPORTED_BUCKETS = original_supported
        bucket_policy.BUCKET_STRATEGY_IDS = original_ids
